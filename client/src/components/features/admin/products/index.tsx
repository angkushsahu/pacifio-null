...
const AdminProducts = () => {
    ...
    const { data, isLoading } = useGetAllProductsForAdminQuery({ query });

    const onPageChange = (pageNumber: number) => {
        setCurrentPage(pageNumber);
        let urlString = `/admin/products?`;
            ...
            {isLoading ? (
                ...
                <section className="admin-workspace">
                    <div className="admin-title-search">
                        <h2 className="admin-workspace--title">All Products</h2>
                        <form className="search_box" onClick={() => searchRef.current?.focus()} onSubmit={onSearch} title="Search Products">
